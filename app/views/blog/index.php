    ...
    <div class="scroll-content row">
        <div class="feature-list clearfix">
            ...
            <?php foreach($posts as $i => $post):?>
                <li>
                    <a href="<?php echo site_url($post->slug);?>" class="feature-olivia col-md-4 col-sm-12 col-xs-12" style="background-image: url(<?php echo config()->baseurl;?>/upload/posts/th-<?php echo count($post->files()) ? $post->files()[0]->name : 'default';?>)">
