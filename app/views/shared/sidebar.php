...
<?php endif;?>
    ...
    <div style="background:url(http://blogs.devmeta.net/upload/posts/th-fist-of-power-e1366397947671_rs.jpg) no-repeat;width:225px;height:225px;padding:25px;text-align:center"><ul style="color:#fff;text-shadow:0 0 2px #000;background-color:rgba(51,51,51,0.5);text-align:left;padding:30px;margin-bottom:30px;"><li>Gratis</li><li>Sin publicidad</li></ul><a href="http://blogs.devmeta.net/" class="btn btn-success" target="_blank">Regístra tu Blog!</a></div>
